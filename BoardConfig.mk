...
TW_THEME := portrait_xxhdpi  # 尝试不同的主题
TW_SCREEN_BLANK_ON_BOOT := true
TW_INPUT_BLACKLIST := "hbtp_vm"
TW_CUSTOM_CPU_TEMP_PATH := "/sys/class/thermal/thermal_zone54/temp"
TW_COLOR_MATRIX_PATH := "/sys/class/graphics/fb0/color_matrix"  # 如果适用
BOARD_HAS_FLIPPED_SCREEN := true  # 如果适用
TW_NO_SCREEN_BLANK := true  # 如果适用
